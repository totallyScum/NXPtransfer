package com.chen.nxp.ui.mission;
 ...
 */
public class MissionItemRecyclerViewAdapter  extends BaseAdapter implements View.OnClickListener{
    ...
    public MissionItemRecyclerViewAdapter(Context context, ArrayList<String> list){
