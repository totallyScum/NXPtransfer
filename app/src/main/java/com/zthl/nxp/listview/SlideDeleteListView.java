...
public class SlideDeleteListView extends ListView {
    ...
    private void init(Context context) {
     ...
     //   view = layoutInflater.inflate(hlq.com.slidedeletelistview.R.layout.slide_item, null);
      ...
      //  btn_delete = view.findViewById(hlq.com.slidedeletelistview.R.id.delete);
    ...
    public void delBtnDelClickListener() {
        this.btnDeleteListern = null;
    }
 ...
 //     btn_delete.getRootView().clearFocus();
    }
}
