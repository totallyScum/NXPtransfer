...
public class AedInvoicesLogResponseBodyPresenter extends BasePresenter {

    private Context mContext;
    private AedInvoicesLogResponsePv aedInvoicesLogResponsePv;
    private ResultNoData resultData2;
    public AedInvoicesLogResponseBodyPresenter (Context context){
        this.mContext = context;
    }

    @Override
    public void BindPresentView(PresentView presentView) {
        aedInvoicesLogResponsePv = (AedInvoicesLogResponsePv) presentView;
    }
    ...
    public void getAedInvoicesLogResponseInfo(AedInvoicesLogRequest aedInvoicesLogRequest) {
        DataManager.getInstance(mContext).getAedInvoicesLogResponseInfo(aedInvoicesLogRequest)
                ...
                .subscribe(new Observer<ResultNoData>() {
                    ...
                    public void onError(Throwable e) {
                        aedInvoicesLogResponsePv.onError("请求失败！！");
                    }

                    @Override
                    public void onComplete() {
                        if (resultData2 != null) {
                            aedInvoicesLogResponsePv.onSuccess(resultData2);
                        }
                        AedInvoicesLogResponseBodyPresenter.super.compositeDisposable.dispose();
                    }
                });
    }
}
